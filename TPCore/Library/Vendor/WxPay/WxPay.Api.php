...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$prePayParams['mch_id']  = WxPayConfig::MCHID;
		$prePayParams['spbill_create_ip']  = $inputObj->GetSpbill_create_ip();
		$prePayParams['notify_url']  = $inputObj->getNotify_url();
		$prePayParams['out_trade_no']  = $inputObj->GetOut_trade_no();
		$prePayParams['body']  = $inputObj->GetBody();
		$prePayParams['trade_type']  = $inputObj->GetTrade_type();
		$prePayParams['total_fee']  = $inputObj->GetTotal_fee();
		$prePayParams['sign']  = $inputObj->GetSign();
