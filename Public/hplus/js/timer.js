			...
			*/
			...
			function showTimer(tempId){
					...
					var timerConent='<table cellpadding="0" cellspacing="0" style="border:#949495 1px solid;table-layout : fixed" >'+
													'<tr style="width:205;height:35">'+
														'<td width="100" style="border:0px;display:block;"><input type="text"  maxlength="2" style="border:0;background:transparent;width:20;height:35" name="HH" value="12" onchange="checkNum('+"'"+tempId+"',"+"'HH',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','HH'"+')"/><input type="text"  style="border:0;background:transparent;width:10;" readOnly=true  value=":"/><input type="text"  maxlength="2" style="border:0;background:transparent;width:20" name="MM" value="45" onchange="checkNum('+"'"+tempId+"',"+"'MM',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','MM'"+')"/><input type="text"  style="border:0;background:transparent;width:10"  readOnly=true value=":"/><input type="text"  maxlength="2" style="border:0;background:transparent;width:25" name="SS" value="12" onchange="checkNum('+"'"+tempId+"',"+"'SS',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','SS'"+')"/></td>'+
														'<td width="40" style="border:0px;"><input type="button" hidefocus="true" style=";border-width:2px;display:block;background:url(images/up.jpg);width:20px;height:10px;" onmouseup="loopBreak()" onmousedown="loopInit('+"'"+tempId+"','+'"+')"/><input type="button" hidefocus="true" style="border-width:2px ;background:url(./img/down.jpg);width:20px;height:10px;" onmouseup="loopBreak()" onmousedown="loopInit('+"'"+tempId+"','-'"+')"/></td>'+
													'</tr>'+
											  	'</table>';
